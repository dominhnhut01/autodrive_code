...
def npy_to_jpg(in_dir,out_dir):
	'''
	This function would convert all the .npy files in the input folder to .jpg file, which would be put in the output folder
	Param:
	...
	for file in os.listdir(in_dir):
	    ...
	    img.save("{}/{}.jpg".format(out_dir,file[:-4]))
